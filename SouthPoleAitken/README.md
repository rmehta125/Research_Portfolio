...
The animations for the energy and pressure during impact are shown in the EnergyAnimSPA.mp4 and PressureAnimSPA.mp4 files in this folder.  EnergyAnimSPA.mp4 displays the energy distribution and extent of the amount of debris launched into orbit. PressureAnim.mp4 shows the pressure waves after the initial impact the rippling over the Moon.  Furthermore, PressureAnimSPA.mp4 displays an overall destruction of the Moon during impact, as at around t = 1 h, a wave of lunar material cascades oveer the body.  This supported the original presumption that an impactor of this size would have resulted in the Moon's destruction.  The crater rim is plotted in CraterRim.png, and the radial distribution of the crater particles is plotted in CraterDist.png.  Overall, the initial impact crater extends to a radius of about 1,800 km.  It is worth noting, however, that in contrast to iSALE, SPH does not handle material strength and instead treats the bodies as fluids.  Therefore, this crater rim radius is best described as a rough estimate based on a simplified model of the debris behavior.
